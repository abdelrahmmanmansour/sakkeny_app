      ...
      child: BlocConsumer<SigInCubit, SigInState>(
        listener: (context, state) {
          if (state is SuccessSignIn) {
            ...
            cubit.userPassWord.clear();
            cubit.userFullName.clear();
            cubit.userEmailController.clear();
            cubit.userIdController.clear();
            cubit.userAgeController.clear();
            cubit.userAddressController.clear();
            cubit.userInfo.clear();
              ...
              children: [
                ...
                CastomText(
                  validator: (p0) {
                    ...
                    // Regex pattern
                    final regex = RegExp(
                        r'^[a-zA-Z0-9]+$'); // Example regex for alphanumeric characters only
                ...
                Row(
                  ...
                  children: [
                    Checkbox(
                        value: checkBoxVale,
                        activeColor: const Color(0xFFFF8C40),
                        onChanged: (newVal) {
                          setState(() {
                            checkBoxVale = newVal!;
                          });
