...
class ChatBox1 extends StatefulWidget {
  const ChatBox1({super.key});

  @override
  State<ChatBox1> createState() => _ChatBox1State();
}

class _ChatBox1State extends State<ChatBox1> {
  @override
  void initState() {
                      ...
                      children: [
                        ...
                        ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            if (cubitChat.getUser[index].userAccountType == "مالك") {
                              return nameMessage(
                                    () {
