...
class HomeRepoImplementation extends HomeRepo {
  ...
  Future<Map<String,dynamic>> signIn(
    ...
    await CacheHelper.saveData(key: "userAccountType", value:responseBody["postUserToReturn"]["userAccountType"]);
    await CacheHelper.saveData(key: "reId", value:responseBody["postUserToReturn"]["userId"]);
    await CacheHelper.saveData(key: "retToken", value:responseBody["token"]);
    return responseBody;
  }
